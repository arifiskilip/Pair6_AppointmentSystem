...
namespace Application.Features.Appointment.Commands.AvailableByDoctor
{
    public class AvailableAppointmentByDoctorCommand : IRequest<AvailableAppointmentByDoctorResponse>, ISecuredRequest, ITransactionalRequest
    {
        ...
        public class AvailableAppointmentByDoctorCommandHandler : IRequestHandler<AvailableAppointmentByDoctorCommand, AvailableAppointmentByDoctorResponse>
        {
            ...
            public AvailableAppointmentByDoctorCommandHandler(IAppointmentRepository appointmentRepository, IAuthService authService, IAppointmentIntervalService appointmentIntervalService)
            {
            ...
            public async Task<AvailableAppointmentByDoctorResponse> Handle(AvailableAppointmentByDoctorCommand request, CancellationToken cancellationToken)
            {
